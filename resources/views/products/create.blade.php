...
@section('title', 'Create Product - SmartPOS')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="warranty_days" class="form-control" value="{{ old('warranty_days', 0) }}" min="0" placeholder="0 = No warranty">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
